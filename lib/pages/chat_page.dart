...
import 'package:chat_mobile/allWidgets/commom_widgets.dart';
import 'package:chat_mobile/model/chat_messages.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<bool> onBackPressed() {
    if (isShowSticker) {
      ...
      chatProvider.updateFirestoreData(FirestoreConstants.pathMessageCollection,
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      Fluttertoast.showToast(
          msg: 'Nada para enviar', backgroundColor: Colors.grey);
    }
  }
...
// Para checkar se a mesnagem foi enviada
